...
internal func requestPhotosNear(_ coordinate: CLLocationCoordinate2D, completionHandler: @escaping((Data?, URLResponse?, Error?) -> Void)) {
    ...
    let request = URLRequest(url: URL(string: "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=15b9dff955bafd96df4e7d92632494fb&lat=\(coordinate.latitude)&lon=\(coordinate.longitude)&extras=url_m&per_page=21&format=json&nojsoncallback=1")!)
